...
var BrowserDetection = {
    ...
    positionNotice: function(){
        ...
        noticeEl.style.top = "50px"; //(windowSize.height - noticeSize.height - 20 + offset) + "px";
    ...
    displayNotice: function(){
        ...
        //if (this.getEl('browser-detection-remind-later')) this.getEl('browser-detection-remind-later').onclick = function () { el.remindMe(false); };
    ...
    writeNoticeCode: function(){
        ...
        //if(displayPoweredBy){
        //	code += '<div class="bd-poweredby">Powered by <a href="//www.devslide.com/labs/browser-detection" target="_blank">DevSlide Labs</a></div>';
        //}
    ...
    browserVersion: '',
    supportedBrowsers: [
           { 'cssClass': 'firefox', 'name': 'Mozilla Firefox', 'downloadUrl': '//www.getfirefox.com/' },
           { 'cssClass': 'chrome', 'name': 'Google Chrome', 'downloadUrl': '//www.google.com/chrome/' },
           //{ 'cssClass': 'msie', 'name': 'Internet Explorer', 'downloadUrl': '//www.getie.com/' },
           //{ 'cssClass': 'opera', 'name': 'Opera', 'downloadUrl': '//www.opera.com/' },
           { 'cssClass': 'safari', 'name': 'Apple Safari', 'downloadUrl': '//www.apple.com/safari/' }
    ],
    operatingSystems: [
    ...
    defaultNotSupportedBrowsers: [
        ...
        { 'os': 'Any', 'browser': 'Firefox', 'version': 30 },
        { 'os': 'Any', 'browser': 'Chrome', 'version': 32 },
        { 'os': 'Any', 'browser': 'Safari', 'version': 7 }//,
    ...
    noticeText: {
        ...
        'professional': { "title": "Outdated or Unsupported Browser Detected", "notice": "Our website has detected that you are using an outdated or unsupported browser. Using your current browser might prevent you from accessing features on our website. An upgrade might not be required, but is strongly recommend to improve your browsing experience on our website.", "selectBrowser": "Use the links below to download a new browser or upgrade your existing one.", "remindMeLater": "Remind me later", "neverRemindAgain": "No, don't remind me again" },
