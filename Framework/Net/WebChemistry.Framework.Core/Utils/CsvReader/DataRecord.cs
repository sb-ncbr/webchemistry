...
using System.Linq;
    ...
    public sealed class DataRecord : RecordBase, IEquatable<DataRecord>
    {
        ...
        static readonly CultureInfo InvCulture = CultureInfo.InvariantCulture;
        ...
        {
            double value;
            if (double.TryParse(this[columnName], NumberStyles.Number, InvCulture, out value)) return value;
            return null;
        }
        ...
        {
            double value;
            if (double.TryParse(this[index], NumberStyles.Number, InvCulture, out value)) return value;
            return null;
        }
        ...
        {
            int value;
            if (int.TryParse(this[columnName], out value)) return value;
            return null;
        }
        ...
        {
            int value;
            if (int.TryParse(this[index], out value)) return value;
            return null;
        }
